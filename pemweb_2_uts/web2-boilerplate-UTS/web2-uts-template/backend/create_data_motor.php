    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                <div class="card-body">
                                <form method="POST" action="proses_data_motor.php">
                                    ...
                                    <div class="form-group">
                                        <label for="merk_id" class="form-label">Merk Motor</label>
                                        <input id="merk_id" name="merk_id" required type="text" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group mt-4">
                                        <input type="submit" name="proses" type="submit" class="btn btn-secondary form-control" value="Simpan" />
                                    </div>
                                </form>
                            </div>
                </main>
